...
(define-package "vcalc-commands"
  ...
  (:exports "*" "*i" "*i/+" "+" "-" "->ieee-754-bits" "->polar"
            "->rectangular" "/" "<" "<=" "=" ">" ">=" "abs" "acos"
            "angle" "apply-to-stack-repeatedly" "asin" "atan" "atan2"
            "begin-editor-with-last-keystroke" "begin-list" "begin-macro"
            "bitwise-and" "bitwise-not" "bitwise-or" "bitwise-shl"
            "bitwise-shr" "bitwise-xor" "butlast" "ceiling" "chs" "clear-data"
            "command-library" "constant-library" "cos" "data-atot" "data-avg"
            "data-corr" "data-cov" "data-log-x" "data-log-y" "data-lr"
            "data-pcov" "data-predx" "data-predx-consuming" "data-predy"
            "data-predy-consuming" "data-sdev" "data-tot" "data-watch"
            "e-constant" "edit-object" "end-list" "end-macro" "enter-object"
            "erf" "evaluate" "exp" "exp10" "export-csv-file" "expt" "factorial"
            "first" "floor" "gamma" "imag-part" "interactive-break"
            "intersect" "last" "last-arguments" "last-stack" "list->"
            "log" "log10" "magnitude" "make-polar" "make-rectangular" "normal-dist"
            "normal-dist-prob" "parse-count" "percent" "percent-delta" "percent-t"
            "phi-constant" "pi-constant"  "prng"  "prng"  "prng-seed"
            "push-data" "rapply"  "real-part"  "redo-stack"  "register-unwatch"
            "register-unwatch-all"  "register-watch" "rest" "rexch"
            "round"  "rrecall"  "set-binary-mode" "set-comma-seperator"
            "set-decimal-mode" "set-degree-mode"  "set-fixed-mode"
            "set-gradian-mode" "set-hexadecimal-mode"  "set-no-seperator"
            "set-octal-mode"  "set-period-seperator" "set-radian-mode"
            "set-scientific-mode"  "sin"  "sqrt"  "srot"  "srotd" "stack-clear"
            "stack-copy"  "stack-cut"  "stack-drop" "stack-dropn"  "stack-dup"
            "stack-dup2"  "stack-paste"  "stack-swap"  "tan"  "toggle-console"
            "truncate"  "union"))
