...
LRef vmsignal(const _TCHAR *signal_name, long n, ...)
{
	...
	signal_args = lcons(simple_intern(signal_name, interp.scheme_package), signal_args);
        ...
        dscwritef(DF_SHOW_VMSIGNALS,
                  _T("; DEBUG: vm-signal :~cS : ~s\n"),
                  signal_name,
                  signal_args);
...
LRef vmerror_wrong_type(int which_argument, LRef new_errobj)
{
    ...
    {
    case 1:  msg = _T(", 1st argument"); break;
    case 2:  msg = _T(", 2nd argument"); break;
    case 3:  msg = _T(", 3rd argument"); break;
    case 4:  msg = _T(", 4th argument"); break;
    case 5:  msg = _T(", 5th argument"); break;
