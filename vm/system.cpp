...
namespace scan {
  ...
  LRef file_details_object(_TCHAR *filename, struct sys_stat_t *info)
  {
    ...
    case SYS_FT_REG:       file_type = keyword_intern(_T("file"));             break;
    case SYS_FT_DIR:       file_type = keyword_intern(_T("directory"));        break;
    case SYS_FT_CHR:       file_type = keyword_intern(_T("character-device")); break;
    case SYS_FT_BLK:       file_type = keyword_intern(_T("block-device"));     break;
    case SYS_FT_FIFO:      file_type = keyword_intern(_T("fifo"));             break;
    case SYS_FT_LNK:       file_type = keyword_intern(_T("symbolic-link"));    break;
    case SYS_FT_SOCK:      file_type = keyword_intern(_T("socket"));           break;
  ...
  LRef lsystem_info()
  {
    ...
    switch(info._eoln) {
    case SYS_EOLN_CRLF:  eoln = keyword_intern(_T("crlf")); break;
    case SYS_EOLN_CR:    eoln = keyword_intern(_T("cr"));   break;
    case SYS_EOLN_LF:    eoln = keyword_intern(_T("lf"));   break;
    }
