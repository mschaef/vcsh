...
BEGIN_VM_CONSTANT_TABLE(fast_op_opcode_t, fast_op_opcode_name)
    VM_CONSTANT(FOP_LITERAL,                  0  )
    VM_CONSTANT(FOP_GLOBAL_REF,               1  )
    VM_CONSTANT(FOP_GLOBAL_SET,               3  )
    VM_CONSTANT(FOP_APPLY_GLOBAL,             5  )
    VM_CONSTANT(FOP_APPLY,                    6  )
    VM_CONSTANT(FOP_IF_TRUE,                  7  )
    VM_CONSTANT(FOP_RETVAL,                   8  )
    VM_CONSTANT(FOP_SEQUENCE,                 9  )
    VM_CONSTANT(FOP_CLOSURE,                  10 )
    VM_CONSTANT(FOP_EQP,                      11 )
    VM_CONSTANT(FOP_CAR,                      12 )
    VM_CONSTANT(FOP_CDR,                      13 )
    VM_CONSTANT(FOP_NOT,                      14 )
    VM_CONSTANT(FOP_NULLP,                    15 )
    VM_CONSTANT(FOP_THROW,                    16 )
    VM_CONSTANT(FOP_CATCH,                    17 )
    VM_CONSTANT(FOP_WITH_UNWIND_FN,           18 )
    VM_CONSTANT(FOP_GET_ENV,                  19 )
    VM_CONSTANT(FOP_GLOBAL_DEF,               20 )
    VM_CONSTANT(FOP_GET_FSP,                  21 )
    VM_CONSTANT(FOP_GET_FRAME,                22 )
    ...
    VM_CONSTANT(FOP_WHILE_TRUE,               28 )
    VM_CONSTANT(FOP_LOCAL_REF_BY_INDEX,       29 )
    VM_CONSTANT(FOP_LOCAL_REF_RESTARG,        30 )
    VM_CONSTANT(FOP_LOCAL_SET_BY_INDEX,       31 )
...
BEGIN_VM_CONSTANT_TABLE(trap_type_t, trap_type_name)
    ...
    VM_CONSTANT(TRAP_OVERFLOW_FIXNUM_FIXCONS    , 27)

    VM_ANON_CONSTANT(TRAP_LAST                  , 27)
...
BEGIN_VM_CONSTANT_TABLE(debug_flag_t, debug_flag_name)
    ...
    VM_CONSTANT(DF_SHOW_THROWS          , 0x00000040)
    VM_CONSTANT(DF_SHOW_TRAPS           , 0x00000080)

    VM_CONSTANT(DF_SHOW_VMERRORS        , 0x00000100)
    VM_CONSTANT(DF_SHOW_GC              , 0x00000200)
    VM_CONSTANT(DF_SHOW_GC_DETAILS      , 0x00000400)
    VM_CONSTANT(DF_PRINT_SYMBOL_PACKAGES, 0x00000800)

    VM_CONSTANT(DF_PRINT_FOR_DIFF       , 0x00001000)
    VM_CONSTANT(DF_PRINT_CLOSURE_CODE   , 0x00002000)
    VM_CONSTANT(DF_PRINT_ADDRESSES      , 0x00004000)
    VM_CONSTANT(DF_SHOW_LOAD_FORMS      , 0x00008000)

    VM_CONSTANT(DF_FASL_SHOW_OPCODES    , 0x00010000)
    VM_CONSTANT(DF_SHOW_FAST_LOAD_FORMS , 0x00020000)
    VM_CONSTANT(DF_SHOW_FAST_LOAD_UNITS , 0x00040000)
    VM_CONSTANT(DF_DEBUGGER_TO_ODS      , 0x00080000)

    VM_CONSTANT(DF_NO_STARTUP           , 0x00100000)
    VM_CONSTANT(DF_TEST_VM              , 0x00200000)

#ifdef WITH_FOPLOG_SUPPORT
    VM_CONSTANT(DF_STARTUP_FOPLOG       , 0x00400000)
#endif
