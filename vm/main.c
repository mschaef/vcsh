...
/* *INDENT-OFF* */
    ...
    register_subr(_T("make-slayout"),                     SUBR_2,     (void*)lmake_slayout                       );
    ...
    register_subr(_T("read-binary-fixnum-u8"),            SUBR_3,     (void*)lread_binary_fixnum_uint8           );
    register_subr(_T("read-binary-fixnum-s8"),            SUBR_3,     (void*)lread_binary_fixnum_int8            );
    register_subr(_T("read-binary-fixnum-u16"),           SUBR_3,     (void*)lread_binary_fixnum_uint16          );
    register_subr(_T("read-binary-fixnum-s16"),           SUBR_3,     (void*)lread_binary_fixnum_int16           );
    register_subr(_T("read-binary-fixnum-u32"),           SUBR_3,     (void*)lread_binary_fixnum_uint32          );
    register_subr(_T("read-binary-fixnum-s32"),           SUBR_3,     (void*)lread_binary_fixnum_int32           );
    register_subr(_T("read-binary-fixnum-u64"),           SUBR_3,     (void*)lread_binary_fixnum_uint64          );
    register_subr(_T("read-binary-fixnum-s64"),           SUBR_3,     (void*)lread_binary_fixnum_int64           );
    ...
    register_subr(_T("slot-ref"),                         SUBR_ARGC,  (void*)lslot_ref                           );
    ...
    register_subr(_T("slayout?"),                         SUBR_1,     (void*)lslayoutp                           );
    register_subr(_T("slayout-name"),                     SUBR_1,     (void*)lslayout_name                       );
    register_subr(_T("slayout-slots"),                    SUBR_1,     (void*)lslayout_slots                      );
    ...
    register_subr(_T("write-binary-fixnum-u8"),           SUBR_4,     (void*)lwrite_binary_fixnum_uint8          );
    register_subr(_T("write-binary-fixnum-s8"),           SUBR_4,     (void*)lwrite_binary_fixnum_int8           );
    register_subr(_T("write-binary-fixnum-u16"),          SUBR_4,     (void*)lwrite_binary_fixnum_uint16         );
    register_subr(_T("write-binary-fixnum-s16"),          SUBR_4,     (void*)lwrite_binary_fixnum_int16          );
    register_subr(_T("write-binary-fixnum-u32"),          SUBR_4,     (void*)lwrite_binary_fixnum_uint32         );
    register_subr(_T("write-binary-fixnum-s32"),          SUBR_4,     (void*)lwrite_binary_fixnum_int32          );
    register_subr(_T("write-binary-fixnum-u64"),          SUBR_4,     (void*)lwrite_binary_fixnum_uint64         );
    register_subr(_T("write-binary-fixnum-s64"),          SUBR_4,     (void*)lwrite_binary_fixnum_int64          );
