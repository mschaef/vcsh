...
/* *INDENT-OFF* */
    ...
    register_subr(_T("read-binary-fixnum-s16"),           SUBR_3,     (void*)lread_binary_fixnum_s16             );
    register_subr(_T("read-binary-fixnum-u32"),           SUBR_3,     (void*)lread_binary_fixnum_u32             );
    register_subr(_T("read-binary-fixnum-s32"),           SUBR_3,     (void*)lread_binary_fixnum_s32             );
    register_subr(_T("read-binary-fixnum-u64"),           SUBR_3,     (void*)lread_binary_fixnum_u64             );
    register_subr(_T("read-binary-fixnum-s64"),           SUBR_3,     (void*)lread_binary_fixnum_s64             );
    ...
    register_subr(_T("write-binary-fixnum-s16"),          SUBR_4,     (void*)lwrite_binary_fixnum_u16            );
    register_subr(_T("write-binary-fixnum-u32"),          SUBR_4,     (void*)lwrite_binary_fixnum_u32            );
    register_subr(_T("write-binary-fixnum-s32"),          SUBR_4,     (void*)lwrite_binary_fixnum_u32            );
    register_subr(_T("write-binary-fixnum-u64"),          SUBR_4,     (void*)lwrite_binary_fixnum_u64            );
    register_subr(_T("write-binary-fixnum-s64"),          SUBR_4,     (void*)lwrite_binary_fixnum_u64            );
