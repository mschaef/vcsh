...
static void test_encode_decode(void (* encode)(uint8_t *buf, fixnum_t num),
...
static void test_encdec_s8 () { test_encode_decode(io_encode_fixnum_s8 , io_decode_fixnum_s8);  }
static void test_encdec_u8 () { test_encode_decode(io_encode_fixnum_u8 , io_decode_fixnum_u8);  }

static void test_encdec_s16() { test_encode_decode(io_encode_fixnum_s16, io_decode_fixnum_s16); }
static void test_encdec_u16() { test_encode_decode(io_encode_fixnum_u16, io_decode_fixnum_u16); }

static void test_encdec_s32() { test_encode_decode(io_encode_fixnum_s32, io_decode_fixnum_s32); }
static void test_encdec_u32() { test_encode_decode(io_encode_fixnum_u32, io_decode_fixnum_u32); }

static void test_encdec_s64() { test_encode_decode(io_encode_fixnum_s64, io_decode_fixnum_s64); }
static void test_encdec_u64() { test_encode_decode(io_encode_fixnum_u64, io_decode_fixnum_u64); }
