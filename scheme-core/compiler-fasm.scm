...
(define-fast-op :literal                #.system::FOP_LITERAL_ALT               :literal           )
(define-fast-op :global-ref             #.system::FOP_GLOBAL_REF_ALT            :symbol            )
(define-fast-op :local-ref              #.system::FOP_LOCAL_REF_ALT             :symbol            )
(define-fast-op :global-set!            #.system::FOP_GLOBAL_SET_ALT            :symbol            )
(define-fast-op :local-set!             #.system::FOP_LOCAL_SET_ALT             :symbol            )
(define-fast-op :apply-global           #.system::FOP_APPLY_GLOBAL_ALT          :symbol :fast-ops  )
(define-fast-op :apply                  #.system::FOP_APPLY_ALT                 :fast-op :fast-ops )
(define-fast-op :if-true                #.system::FOP_IF_TRUE_ALT               :fast-op :fast-op  )
(define-fast-op :retval                 #.system::FOP_RETVAL_ALT                                   )
(define-fast-op :sequence               #.system::FOP_SEQUENCE_ALT              :fast-op :fast-op  )
(define-fast-op :closure                #.system::FOP_CLOSURE_ALT               :literal :fast-op  )
(define-fast-op :eqp                    #.system::FOP_EQP_ALT                   :fast-op :fast-op  )
(define-fast-op :car                    #.system::FOP_CAR_ALT                                      )
(define-fast-op :cdr                    #.system::FOP_CDR_ALT                                      )
(define-fast-op :not                    #.system::FOP_NOT_ALT                                      )
(define-fast-op :nullp                  #.system::FOP_NULLP_ALT                                    )
(define-fast-op :throw                  #.system::FOP_THROW_ALT                 :fast-op :fast-op  )
(define-fast-op :catch                  #.system::FOP_CATCH_ALT                 :fast-op :fast-op  )
(define-fast-op :with-unwind-fn         #.system::FOP_WITH_UNWIND_FN_ALT        :fast-op :fast-op  )
(define-fast-op :get-env                #.system::FOP_GET_ENV_ALT                                  )
(define-fast-op :global-def             #.system::FOP_GLOBAL_DEF_ALT            :symbol :literal   )
(define-fast-op :get-fsp                #.system::FOP_GET_FSP_ALT                                  )
(define-fast-op :get-frame              #.system::FOP_GET_FRAME_ALT                                )
(define-fast-op :get-hframes            #.system::FOP_GET_HFRAMES_ALT                              )
(define-fast-op :set-hframes            #.system::FOP_SET_HFRAMES_ALT           :fast-op           )
(define-fast-op :global-preserve-frame  #.system::FOP_GLOBAL_PRESERVE_FRAME_ALT :symbol :fast-op   )
