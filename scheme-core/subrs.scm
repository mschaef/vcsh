...
(define apply-macro #.(scheme::%subr-by-name "apply-macro"))
...
(define macro? #.(scheme::%subr-by-name "macro?"))
(define macroexpand #.(scheme::%subr-by-name "macroexpand"))
(define macroexpand! #.(scheme::%subr-by-name "macroexpand!"))
(define macroexpand-1 #.(scheme::%subr-by-name "macroexpand-1"))
(define macroexpand-1! #.(scheme::%subr-by-name "macroexpand-1!"))
