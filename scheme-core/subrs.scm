...
(%define %instance-map #.(host-scheme::%subr-by-name "%instance-map"))
...
(%define %set-instance-proto! #.(host-scheme::%subr-by-name "%set-instance-proto!"))
...
(%define clone-instance #.(host-scheme::%subr-by-name "clone-instance"))
...
(%define enlarge-heap #.(host-scheme::%subr-by-name "enlarge-heap"))
...
(%define instance? #.(host-scheme::%subr-by-name "instance?"))
...
(%define make-instance #.(host-scheme::%subr-by-name "make-instance"))
...
(%define port-io-counts #.(host-scheme::%subr-by-name "port-io-counts"))
...
(%define read-binary-fixnum #.(host-scheme::%subr-by-name "read-binary-fixnum"))
...
(%define send #.(host-scheme::%subr-by-name "send"))
...
(%define vector? #.(host-scheme::%subr-by-name "vector?"))
(%define write-binary-fixnum #.(host-scheme::%subr-by-name "write-binary-fixnum"))
